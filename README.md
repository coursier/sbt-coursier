...
[coursier](https://github.com/coursier/coursier)-based `DependencyResolution` implementation
for sbt's library management (`lm-coursier` and its shaded variant, `lm-coursier-shaded`)
